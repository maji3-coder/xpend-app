...
For a real signed APK use the `xpend-android` wrapper project — just change `SERVER_URL` to your GitHub Pages URL.
...
| File | Variable | Value |
|------|----------|-------|
| `index.html` | Supabase URL | `https://fydijvhjvukyrqcxacau.supabase.co` |
